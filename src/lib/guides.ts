...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    description:
      "로또에 당첨되면 어디로 가야 할까요? 1·2등은 농협은행 본점, 3등 이하는 은행이나 판매점 등 등수별 수령 장소와 필요 서류, 지급 기한 1년 규정을 정리했습니다.",
    summary:
  ...
  },
  {
    ...
    description:
      "로또 당첨금에는 기타소득세 20%(3억 초과분 30%)와 지방소득세가 붙습니다. 당첨금별 실수령액을 표로 정리하고 세금 계산 방식을 예시와 함께 설명합니다.",
    summary:
  ...
  },
  {
    ...
    description:
      "로또 6/45를 사는 방법을 판매점 구매와 동행복권 인터넷 구매로 나눠 설명합니다. 자동·수동·반자동의 차이, 1인당 구매 한도, 구매 마감 시간까지 정리했습니다.",
    summary:
